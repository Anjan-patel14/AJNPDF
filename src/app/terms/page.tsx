...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description: 'Read the AJN PDF Terms of Use covering permitted use, prohibited activity, PDF processing limitations, availability and user responsibilities.',
    ...
    <LegalPageShell
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            'PDF files can contain features that are not preserved by every edit, conversion, page-copy or repair operation. Fonts, forms, links, accessibility tags, embedded media, annotations, signatures and layout may change depending on the source file and selected workflow.',
            'AJN PDF does not guarantee that every output will be suitable for legal filing, archival compliance, accessibility certification, publishing or professional print production. Always keep the original document and review the downloaded result.',
          ],
        },
        {
          title: 'Availability',
